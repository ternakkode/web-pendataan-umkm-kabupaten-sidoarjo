@extends('layout.umkm')
@section('title', 'Edit Informasi UMKM')
@section('content')
<form method="POST">
    @csrf
    @if ($errors->any())
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ubah Informasi UMKM</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
            ...
            <div class="navigation text-center">
                <button type="submit" class="btn btn-success w-100 font-weight-bold">SIMPAN PERUBAHAN</button>
            </div>
        </div>
    </div>
</form>
