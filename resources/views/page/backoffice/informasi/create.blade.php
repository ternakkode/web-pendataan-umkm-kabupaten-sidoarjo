...
@section('content')
<form method="POST" action="{{ url('backoffice/informasi') }}" enctype="multipart/form-data">
    @csrf
    @if ($errors->any())
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Buat Informasi Baru</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul" id="form_judul">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea class="form-control" name="deskripsi" id="form_deskripsi" rows="2"></textarea>
                        </div>
