...
@section('content')
<form method="POST" action="{{ url('backoffice/user/'.$user->id) }}" enctype="multipart/form-data">
@method('PUT')
    @csrf
    @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="form_email" value="{{ $user->email }}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="nama">Username</label>
                                <input type="text" class="form-control" name="username" id="form_username" value="{{ $user->username }}" readonly>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
